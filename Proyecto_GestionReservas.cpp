// Proyecto_GestionReservas.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	do
	{
		...
		cout << "___________________________________________________________________________" << endl;
		cout << endl;
		cout << "Ingrese 1 para cargar los datos del huesped" << endl;
		cout << "Ingrese 2 para mostrar los datos cargados" << endl;
		cout << "Ingrese 3 para buscar huesped por DNI y sus tramites" << endl;
		cout << "Ingrese 4 para Organizar informacion de un cliente en un vector" << endl;
		cout << "Ingrese 5 para Mostrar el vector ordenado alfabeticamente" << endl;
		cout << "ingrese 6 para generar otro vector con datos de clientes sin Cant. dias" << endl;
		cout << "___________________________________________________________________________" << endl;
		cout << "___________________________________________________________________________" << endl;
		cout << "___________________________________________________________________________" << endl;
		cout << "___________________________________________________________________________" << endl;
...
void cargar(Huesped *&v, int &n)
{
	...
	do
	{
		cout << "ingrese un nuemro mayor a cero" << endl;
		cin >> n;
		if (n >= 0)
		{
	...
	cout << "cargue los datos del Huesped" << endl;

	for (int i = 0; i < n; i++)
	{
		cout << "Ingrese los datos del DNI: " << i + 1 << endl;
		v[i].DNI = car_DNI();
...
long int car_DNI()
{
	...
	cout << "Ingrese el numero de DNI del huesped" << endl;
	do
	{
		cin >> NDNI;
		...
		if (NDNI > 0)
		{
			cout << "Ingrese un nuemro DNI por favor" << endl;
			system("pause");
			system("cls");
		}
	} while (NDNI > 0);
...
int car_dias()
{
	...
	cout << "Numero de dias en el Hotel: " << endl;
	do
	{
		cin >> DIAS;
		if (DIAS > 0)
